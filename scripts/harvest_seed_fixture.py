...
Run once, deliberately. The output is committed twice over:
    ...
    Manga-ReaderTests/SimulatorSeedFixture.swift the generated rows the seed installs
...
SWIFT = os.path.join(HERE, "..", "Manga-ReaderTests", "SimulatorSeedFixture.swift")
UA = "Manga-Reader-seed-harvest/1.0"
